...
export default function ProfileCard() {
  return (
    <div className="w-[320px] min-h-[560px] bg-white rounded-[28px] shadow-2xl px-6 py-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-35 left-10 w-24 h-24 border-b-4 border-dashed border-orange-400 opacity-80" />
    </div>
  );
}
